...
public class ChromaticTuningClass extends AppCompatActivity implements GestureDetector.OnGestureListener {
    private GestureDetector gestureDetector;
    private final Context context = this;

    public String TuneCase = "guitar";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chromatic_tuning_class);

        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction ft = fm.beginTransaction();
        ft.replace(R.id.fragment_place, new ChromaticFragment());
...
//            Toast.makeText(GeneralTuningClass.this,"You are already in this mode",
...
//        }
    ...
    public void showPopup(View v) {
        ...
        inflater.inflate(R.menu.menu_for_chromatic, popup.getMenu());
        popup.show();
    ...
    private void onSwipeRight() {
        Toast.makeText(ChromaticTuningClass.this,"Swipe Right",
                Toast.LENGTH_SHORT).show();
    }

    private void onSwipeLeft() {
        Toast.makeText(ChromaticTuningClass.this,"Swipe Left",
                Toast.LENGTH_SHORT).show();
