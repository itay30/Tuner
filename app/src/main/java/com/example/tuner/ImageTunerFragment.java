...
public class ImageTunerFragment extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_image_tuner_fragment);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemID == R.id.switch_begginer)
            ...
            ImageTunerFragment.this.startActivity(intent);}
        else if (itemID == R.id.switch_ukulele){
            fragment = new UkuleleTunerFragment();
            FragmentManager fm = getSupportFragmentManager();
            FragmentTransaction ft = fm.beginTransaction();
            ft.replace(R.id.tuningFragment, fragment);
            ft.commit();
        }
